...
```{r feature-imp rfr, echo=FALSE, fig.cap="Figure 1. Random Forest Regressor Feature Importances", out.width = '100%'}
knitr::include_graphics("../results/feature_importance_rfr_plot.png")
```
...
```{r feature-imp rfc, echo=FALSE, fig.cap="Figure 1. Random Forest Classifier Feature Importances", out.width = '100%'}
knitr::include_graphics("../results/feature_importance_rfc_plot.png")
```
