...
# image2 = "../results/feature_importance_rfc_plot.png"
...
# Building regression models
    ...
    feature_importance_rfr_plot = sns.barplot(x="importances", y="features", data=feat_df, color="salmon").set_title('Feature Importance from RF   Regression', weight='bold')
    plt.xlabel("Importances")
    plt.ylabel("Features")
    plt.show("feature_importance_rfr");
    
    # Saving plot as an output           
    plt.save(image1_file + "feature_importance_rfr_plot.png")
    ...
    # --> SECOND OUTPUT: Barplot of feature importances
    feature_importance_rfc_plot = sns.barplot(x="importances", y="features", data=feat_df, color="salmon").set_title('Feature Importance from RF Classifier', weight='bold')
    plt.xlabel("Importances")
    plt.ylabel("Features")
    plt.show(feature_importance_rfc_plot);

    
    # Saving plot as an output           
    plt.save(image2_file + "feature_importance_rfc_plot.png")
